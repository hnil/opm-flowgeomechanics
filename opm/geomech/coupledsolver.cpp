...
// ----------------------------------------------------------------------------
std::vector<size_t>
remaining(const size_t N, const std::vector<size_t>& elim)
// ----------------------------------------------------------------------------
{
...
// removed).
SMatrix
reduceMatrix(SMatrix& M, bool rows, bool cols, const std::vector<size_t> elim)
// ----------------------------------------------------------------------------
{
    assert(cols || rows);
...
// ----------------------------------------------------------------------------
ResVector
reduceVector(const ResVector& v, const std::vector<size_t>& keep)
// ----------------------------------------------------------------------------
{
