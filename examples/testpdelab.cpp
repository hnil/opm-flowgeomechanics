...
public:
    ...
    typename Traits::RangeFieldType lambda(const typename Traits::ElementType& e,
                                           const typename Traits::DomainType& x) const
    {
        return lambda_;
    }

    typename Traits::RangeFieldType mu(const typename Traits::ElementType& e,
                                       const typename Traits::DomainType& x) const
    {
        return mu_;
    }
...
template <class GV>
void
testp1(const GV& gv, double mu, double lambda, double constG)
{
    ...
    typedef Dune::PDELab::VectorGridFunctionSpace<GV,
                                                  FEM,
                                                  dim,
    ...
    Dune::FieldVector<double, dim> G(0.0);
    G[dim - 1] = -constG;
    ...
    // make grid operator
    typedef Dune::PDELab::GridOperator<GFS, GFS, LO, MBE, double, double, double, C, C> GOS;
